...
public class RouteParser {
	    ...
	    try {
	        ...
	        for (int m = 0; m < routeJSONArray.length(); m++) {
	            ...
	            for (int b = 0; b < legsJSONArray.length(); b++) {
	                ...
	                GeoPoint stepStartLocationLatLng, stepEndLocationLatLng;
	                for (int i = 0; i < stepsJSONArray.length(); i++) {
	                    ...
	                    stepEndLocationLatLng = new GeoPoint(stepEndLocationJSONObject.getDouble(LATITUDE), stepEndLocationJSONObject.getDouble(LONGITUDE));
	                    ...
	                    stepStartLocationLatLng = new GeoPoint(stepStartLocationJSONObject.getDouble(LATITUDE), stepStartLocationJSONObject.getDouble(LONGITUDE));
	...
	public static List<GeoPoint> getWholeRoutePoints(Route route){
    ...
    private static List<GeoPoint> decodePolyLines(String encoded) {
