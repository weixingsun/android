...
import static cat.app.navi.google.MathUtil.*;
...
public class PolyUtil {
     ...
     */
    public static boolean isLocationOnEdge(GeoPoint point, List<GeoPoint> polygon, boolean geodesic,
                                           double tolerance) {
     ...
     */
    public static boolean isLocationOnPath(GeoPoint point, List<GeoPoint> polyline,
    ...
    private static boolean isLocationOnEdgeOrPath(GeoPoint point, List<GeoPoint> poly, boolean closed,
        ...
        double lat3 = toRadians(point.getLatitude());
        double lng3 = toRadians(point.getLongitude());
        GeoPoint prev = poly.get(closed ? size - 1 : 0);
        double lat1 = toRadians(prev.getLatitude());
        double lng1 = toRadians(prev.getLongitude());
        if (geodesic) {
            for (GeoPoint point2 : poly) {
                double lat2 = toRadians(point2.getLatitude());
                double lng2 = toRadians(point2.getLongitude());
