...
test_file='C:/Users/SUN/Desktop/www/google_poi_admin/dst/test.json'
test_admin_file='C:/Users/SUN/Desktop/www/google_poi_admin/dst/test_admin.txt'
google_url='http://maps.googleapis.com/maps/api/geocode/json?latlng='  #39.761442,-104.801158
test_url='http://maps.googleapis.com/maps/api/geocode/json?latlng=-43.525827,172.584113'
#deleteFile(test_admin_file)
#json_text = getHtml3(test_url).decode("utf-8")
#appendTxt(test_file,json_text)
#admin = getAdmin(json_text)
#columns = defaultdict(list)
loopInCSV('nz.csv','nz_write.csv')
